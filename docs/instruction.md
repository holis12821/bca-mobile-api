...
dulu. sebenarnya saya sudah setup penjelasan yang ada di file docs/07-SETUP-RUNBOOK.md, sudah sampai Dependencies, anda kerjakan sisanya ya, tetapi anda analisa dulu ya.

setelah selesai : Taruh migrasi 000001-000008 dari docs/02-DATABASE-SCHEMA.md ke migrations/,
satu file .up.sql dan .down.sql per nomor. File down harus benar-benar
membalik file up-nya, bukan placeholder kosong. Lalu jalankan: make infra-up && make migrate-up && make verify-009 Laporkan hasilnya. DoD fase 0: 64 akun internal ada, verify-009 nol FAIL.
